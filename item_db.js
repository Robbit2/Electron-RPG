const items = {
    ...
    steel_sword : {name:"Steel Sword",img:"./img/items/weapons/swords/steel_sword.png",id:"weapon:steel_sword",atk:20,def:0,type:"weapon",rarity:"#a8a8a8",level:4,gilded:false,stars:"",reforge:"",atkBuff:0,defBuff:0},
    steel_helmet : {name:"Steel Helmet",img:"./img/items/armor/steel_helmet.png",id:"armor:steel_helmet",atk:0,def:25,type:"armor.helmet",rarity:"#a8a8a8",level:4,gilded:false,stars:"",reforge:"",atkBuff:0,defBuff:0},
    steel_chestplate : {name:"Steel Chestplate",img:"./img/items/armor/steel_chestplate.png",id:"armor:steel_chestplate",atk:0,def:30,type:"armor.chest",rarity:"#a8a8a8",level:4,gilded:false,stars:"",reforge:"",atkBuff:0,defBuff:0},
    steel_boots : {name:"Steel Boots",img:"./img/items/armor/steel_boots.png",id:"armor:steel_boots",atk:0,def:20,type:"armor.legs",rarity:"#a8a8a8",level:4,gilded:false,stars:"",reforge:"",atkBuff:0,defBuff:0}
